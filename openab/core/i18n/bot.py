...
MESSAGES = {
    "zh": {
        ...
        "session_resume_usage": "使用 /resume 会显示近期会话列表（来自 ~/.cursor/chats），点击按钮即可切换；也可选「延续上一会话」或「创建新会话」，无需记忆 ID。",
        "session_resume_usage_discord": "使用 !resume 或 /resume 会显示近期会话列表，点击按钮即可切换；也可选「延续上一会话」或「创建新会话」。",
        "sessions_list_unavailable": "使用 /resume 会列出近期会话按钮，点击即可切换；也可选择「延续上一会话」或「创建新会话」。会话列表来自本机 ~/.cursor/chats。",
        "session_resume_choose": "请选择：",
        "btn_resume_latest": "延续上一会话",
        "btn_new_session": "创建新会话",
    },
    "en": {
        "unauthorized": (
        ...
        "session_resume_usage": "Use /resume to see recent sessions as buttons (from ~/.cursor/chats); tap to switch or choose “Resume latest” / “New session” — no need to remember IDs.",
        "session_resume_usage_discord": "Use !resume or /resume to see recent sessions; tap a button to switch or choose “Resume latest” / “New session”.",
        "sessions_list_unavailable": "Use /resume to see recent sessions as buttons (from ~/.cursor/chats); tap to switch, or choose “Resume latest” / “New session”.",
        "session_resume_choose": "Choose:",
        "btn_resume_latest": "Resume latest session",
